...
[$\rightarrow$ \href{http://www.biostat.wisc.edu/~kbroman/teaching}{Teaching} $\rightarrow$ 
\href{http://www.biostat.wisc.edu/~kbroman/teaching/misc}{Miscellaneous lectures}]}
}
...
\setlength{\rightskip}{0pt plus 1fil} % makes ragged right
  ...
  BB/AB. \\
  {\color{myblue} (Or 2/1/0 if the QTL genotype is BB/AB/AA in an intercross.)} \\
...
\begin{tabular}{ccccc} \hline
 & & \hspace*{5mm} & \multicolumn{2}{c}{QTL genotype} \\ \cline{4-5}
$\mathsf{M_1}$ & $\mathsf{M_2}$ & & BB & AB \\ \hline
BB & BB & & $\mathsf{(1-r_L)(1-r_R)/(1-r)}$ & $\mathsf{r_L r_R / (1-r)}$ \\
BB & AB & & $\mathsf{(1-r_L)r_R/r}$         & $\mathsf{r_L(1-r_R)/r}$ \\
AB & BB & & $\mathsf{r_L(1-r_R)/r}$         & $\mathsf{(1-r_L)r_R/r}$ \\
AB & AB & & $\mathsf{r_L r_R / (1-r)}$ & $\mathsf{(1-r_L)(1-r_R)/(1-r)}$ \\ \hline
