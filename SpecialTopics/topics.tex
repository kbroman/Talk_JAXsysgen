...
\begin{eqnarray*}
\text{H}_0: y & = & \mu + \alpha x + \epsilon \\
\text{H}_a: y & = & \mu + \alpha x + \beta q + \epsilon
\end{eqnarray*}
...
\begin{itemize}
\item If covariate has strong effect on the phenotype, this can give
  improved power to detect QTL.
\item In permutations, keep phenotype and covariate together
\item Use care when covariate is another phenotype
\end{itemize}
\end{minipage}
...
\text{H}_0: y & = & \mu + \alpha x + \epsilon \\
\text{H}_a: y & = & \mu + \alpha x + \beta q + \epsilon \\
\text{H}_i: y & = & \mu + \alpha x + \beta q + \gamma x q + \epsilon
\end{eqnarray*}
