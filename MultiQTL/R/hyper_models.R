...
xx <- 110; yy <- 40
segments(x[3], y[3], x[4], y[4], lwd=2, ljoin=1, lend=1)
if(bw) { segments(x[4], y[4], xx, yy, lwd=2, ljoin=1, lend=1, lty=2) 
} else { segments(x[4], y[4], xx, yy, lwd=2, ljoin=1, lend=1, col=color[1])}
points(x, y, pch=16, cex=4, lwd=2, col=bgcolor)
points(x, y, pch=1, cex=4, lwd=2)
...
segments(x[3], y[3], x[4], y[4], lwd=2, ljoin=1, lend=1)
if(bw) {
segments(x[4], y[4], xx, yy, lwd=2, ljoin=1, lend=1, lty=2)
} else {
